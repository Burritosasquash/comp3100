...
while(!str.contains("NONE")){
	...
	if(str.contains("JOBN")){
		...
		//checks what servers are available		
		...
		//checks if there are no servers available, if so begin checking capable
